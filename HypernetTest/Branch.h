...
public:
    ...
    Branche(std::vector<double> C, const int& power, const int& firstNode, const int& secondNode, const int& simple, const bool & isReliable) :
            _C(std::move(C)),
            _power(power),
...
Branche operator *(Branche x, Branche y);
Branche operator +(Branche x, Branche y);
Branche operator -(Branche x, Branche y);
Branche operator ~(Branche x);
Branche operator *(int x, Branche y);
Branche operator *(Branche x, int y);